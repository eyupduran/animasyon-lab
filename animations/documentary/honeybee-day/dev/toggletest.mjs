...
await page.goto('http://127.0.0.1:5230/index.html?t=30', { waitUntil: 'load' });
...
const stored = await page.evaluate(() => [localStorage.getItem('honeybee.cc'), localStorage.getItem('honeybee.voice')]);
