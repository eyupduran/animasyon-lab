...
export const TOD = {
  ...
  morning: {
    ...
    fog: C('#dbe3e8'), fogDen: 0.00016, rimCol: C('#fff0d8'), rim: 0.55,
  ...
  day: {
    ...
    fog: C('#dfe7ec'), fogDen: 0.0001, rimCol: C('#ffffff'), rim: 0.4,
  ...
  noon: {
    ...
    fog: C('#e0e7eb'), fogDen: 0.0001, rimCol: C('#ffffff'), rim: 0.35,
