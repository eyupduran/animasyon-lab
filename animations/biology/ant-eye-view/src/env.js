...
import {
  ...
  RawCubeTexture, Constants, HDRFiltering, DefaultRenderingPipeline, ImageProcessingConfiguration,
...
export function createCinema(engine, canvas, { quality = 'high' } = {}) {
  ...
  ip.vignetteEnabled = true; ip.vignetteWeight = 2.2; ip.vignetteStretch = 0.4; ip.vignetteColor = new Color4(0.05, 0.03, 0.01, 0);
  ...
  ip.colorCurves = cc;
  pipe.bloomEnabled = true; pipe.bloomThreshold = 0.85; pipe.bloomWeight = 0.35; pipe.bloomKernel = 96; pipe.bloomScale = 0.5;
  ...
  pipe.chromaticAberrationEnabled = true; pipe.chromaticAberration.aberrationAmount = 14; pipe.chromaticAberration.radialIntensity = 1.2;
